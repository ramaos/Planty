...
<script type="text/template" id="tmpl-elementor-panel-schemes-disabled">
	...
	<div class="elementor-nerd-box-title">{{{ '<?php echo esc_html__('%s are disabled', 'elementor'); // phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment 
												?>'.replace( '%s', disabledTitle ) }}}</div>
